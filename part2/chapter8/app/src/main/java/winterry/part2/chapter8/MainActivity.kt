...
import winterry.part2.chapter8.databinding.ActivityMainBinding
        ...
        binding.searchView.setOnQueryTextListener(object: OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                return if (query?.isNotEmpty() == true) {
                    SearchRepository.getFavoriteRestaurant(query).enqueue(object: Callback<SearchResult> {
                        override fun onResponse(call: Call<SearchResult>, response: Response<SearchResult>) {
                            ...
                            Log.e("ee", searchItemList.toString())
                            ...
                            markers = searchItemList.map {
                                Marker(LatLng(it.mapy.toDouble()/CORRECT_VAL, it.mapx.toDouble()/CORRECT_VAL)).apply {
