package com.winterry.movieapp.ui.components.dialog.components.content
...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val starBackgroundColor = MaterialTheme.colorScheme.inversePrimary.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.colorScheme.inversePrimary.copy(
                alpha = 0.05f
            ).toArgb()
